...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ma.digital.prospace.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ma.digital.prospace.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ma.digital.prospace.domain.User.class.getName());
