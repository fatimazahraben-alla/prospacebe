...
public class CompteProMapperImpl implements CompteProMapper {
    ...
    public EntrepriseDTO toDtoEntrepriseId(Entreprise entreprise) {
        ...
        entrepriseDTO.setDenomination( entreprise.getDenomination() );
        entrepriseDTO.setStatutJuridique( entreprise.getStatutJuridique() );
        entrepriseDTO.setTribunal( entreprise.getTribunal() );
        entrepriseDTO.setNumeroRC( entreprise.getNumeroRC() );
        entrepriseDTO.setIce( entreprise.getIce() );
        entrepriseDTO.setActivite( entreprise.getActivite() );
        entrepriseDTO.setFormeJuridique( entreprise.getFormeJuridique() );
        if ( entreprise.getDateImmatriculation() != null ) {
            entrepriseDTO.setDateImmatriculation( entreprise.getDateImmatriculation().toString() );
        }
        entrepriseDTO.setEtat( entreprise.getEtat() );
