...
public abstract class Session_ {
	...
	/**
	 * @see ma.digital.prospace.domain.Session#compteId
	 **/
	public static volatile SingularAttribute<Session, Long> compteId;
	...
	/**
	 * @see ma.digital.prospace.domain.Session#entrepriseId
	 **/
	public static volatile SingularAttribute<Session, Long> entrepriseId;
	...
	public static final String COMPTE_ID = "compteId";
